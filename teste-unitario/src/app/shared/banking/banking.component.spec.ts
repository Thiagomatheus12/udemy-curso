...
describe('BankingComponent', () => {
  ...
  it(`(U) setSacar(): shoud transfer carteira transfer poupanca dont have string (isNaN) or poupanca < value`, () => {
  ...
  it(`(U) setDepositar(): shoud transfer carteira transfer carteira dont have string (isNaN) or carteira < value`, () => {
